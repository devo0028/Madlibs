const littleRed = {
    ...
    pluralNouns: ['Peaches', 'granola bars', 'staminans', 'bombs'],
    adjective: 'sweet',
...
littleRed.color = 'Dark Green'
littleRed.pluralNouns[2] = 'Beekinis'
littleRed.exclamation = 'IMSOANGRYICOULDPUNCHAHOLEINASOILDCONCRETEWALL!'
littleRed.verbs[1] = 'curb stomp'
console.log(`One day, Little ${littleRed.color} Riding Hood was going through the forest carrying a 
basket of ${littleRed.pluralNouns[0]} for her grandmother. Suddenly, she met a big 
${littleRed.adjective} wolf.
...
const snowWhite = {
    pNouns: ['trashbags', 'cameras'],
    number: 2593,
    adjects: ['cracked', 'sad', 'twisted'],
    noun: ['ghost', 'child', 'eye', 'rock', 'fangirl'],
    color: 'dark cranberry',
    bodyPart: 'foot',
    adverb: 'firmly'
}
console.log(`One of the most popular fairy ${snowWhite.pNouns[0]} of all time is Snow White and the 
${snowWhite.number} ${snowWhite.pNouns[1]}.

Snow White is a princess whose ${snowWhite.adjects[0]} beauty threatens her stepmother, 
the queen. Snow White is forced to flee from the ${snowWhite.noun[0]} in which she lives 
and hide in a nearby ${snowWhite.noun[1]}.

Once there, she is discovered by ${snowWhite.adjects[1]} animals who guide her to the 
${snowWhite.adjects[2]} cottage of the seven dwarfs. The dwarfs take care of her until 
...
snowWhite.number = 45756438585
snowWhite.adjects[0] = 'wet'
snowWhite.noun[1] = 'robot'
snowWhite.noun[3] = 'father'
snowWhite.color = 'light greeinish brown'
console.log(`One of the most popular fairy ${snowWhite.pNouns[0]} of all time is Snow White and the 
${snowWhite.number} ${snowWhite.pNouns[1]}.
